[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11862308&assignment_repo_type=AssignmentRepo)
...
![8 post-it notes with pros and cons of the current Badger Bakery website](figures/1empathize.png)
...
![8 post-it notes organized into three color-coded categories](figures/2define.png)
...
* the image should be different for each page and span the width of the webpage
* the home page should have an eye-catching image
* the Home, About Us, Order, Contact Us buttons should be in a ribbon with a background color
* the Order button should be large and obvious
* each item should have an image
* the quantity for items should be a dropdown box instead of textbox
* the Contact page should have a map and address of the bakery

![4 screens showing each webpage of the website](figures/3ideate.png)
